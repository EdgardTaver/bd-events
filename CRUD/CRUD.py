...
class GrupoMusical():
    ...
    def updateGrupoMusical(self, where, newName, biography, origin):
        ...
        try:
            cur.execute(commandString, (newName, biography, origin, where))
...
class PlaylistCompostaPorMuisca():
    ...
    def deletePlaylistCompostaPorMusica(self, idPlaylist, idMusic):
        ...
        try:
            ...
            return("Musica nao encontrada na playlist")
...
class main():
    ...
    def menu(self):
        ...
        print(playlistComposite.createPlaylistCompostaPorMusica("PlaylistED", "Rap God"))
